			...
			<div class="thumbnail-body">
				...
				<div class="tour-info">
					...
					<div class="price-box">
						...
						<a href="<?php echo esc_url( get_bloginfo( 'url' ) . '/' .$tourSettings['tm_tour_page_template'] ) . '?id=' . get_the_ID(); ?>" class="btn btn-add-tour"><?php _e( 'Book tour', 'piklist-tour' ); ?> <i class="icon fa fa-chevron-right"></i></a>
					</div>
				</div>
				<!-- /.meta-tour-info -->
			</div> 
